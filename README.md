...
|14.|Rotate List|[Problem](https://leetcode.com/problems/rotate-list/)|[Solution](https://github.com/samahuja642/leetcode/blob/main/linked_list/rotate_list.cpp)|Medium|No|
## Recursion
|S.no | Title      | Problem        | Solution      |  Difficulty | Revisit Require |
|-----:|------------|--------------:|-------------:| ----------:|------------------:|
